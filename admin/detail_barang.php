            ...
            <nav class="space-y-2">
                ...
                <div class="pt-4">
                    ...
                    <a href="data_barang.php" class="flex items-center px-4 py-3.5 gradient-bg text-white rounded-xl shadow-lg transition-all duration-200 group relative overflow-hidden">
                        ...
                        <span class="ml-auto text-xs bg-white/20 px-2 py-1 rounded-lg font-bold"><?php echo $total_barang; ?></span>
                ...
                <div class="pt-4">
                    ...
                    <a href="kelola_lelang.php" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group hover:bg-blue-50" style="color:var(--primary-700)">
                        ...
                        <span class="ml-auto text-xs px-2 py-1 rounded-lg font-bold" style="background:var(--primary-100);color:var(--primary-600)"><?php echo $total_lelang; ?></span>
                    </a>

                    <a href="pembayaran.php" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group hover:bg-blue-50 mt-1" style="color:var(--primary-700)">
                    ...
                    <a href="laporan.php" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group hover:bg-blue-50 mt-1" style="color:var(--primary-700)">
